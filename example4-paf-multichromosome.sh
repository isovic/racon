...
reads=test-data/multichromosome/pacbio_filtered.fastq
reference=test-data/multichromosome/ecoli_K12_MG1655_U00096.3.fasta
dataset=lambda_30x_ont
suffix=mhap

layout_fasta=test-data/multichromosome/ecoli_pacbio_filtered.asm.split.fasta
